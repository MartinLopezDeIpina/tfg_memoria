\todo{Voy a añadir una sección al capítulo de ``Diseño del sistema'' donde se explique la lógica detrás de separar los agentes. He pensado en algo como el anexo \ref{anexo:design}}
