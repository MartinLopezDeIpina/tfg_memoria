...
Es de destacar que las memorias recuperadas se insertan como mensajes \opus{AIMessage} entre el mensaje del sistema y la consulta del usuario, ya que incluirlas en el \opus{SystemMessage}, se observó que el agente tendía a ignorarlas.
